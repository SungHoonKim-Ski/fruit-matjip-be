...
public abstract class IntegrationTestBase {
    ...
    protected <T> ApiResponse<T> postAction(String uri, Object request, Class<T> responseType) throws Exception {
        return performAction(
                post(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(request)),
                responseType);
    }
    ...
    protected <T> ApiResponse<T> postAction(String uri, Object request, String accessToken, Class<T> responseType)
            throws Exception {
        return performAction(post(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON)
    ...
    protected <T> ApiResponse<T> putAction(String uri, Object request, Class<T> responseType) throws Exception {
        return performAction(
                put(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(request)),
                responseType);
    }
    ...
    protected ApiResponse<Void> patchAction(String uri, String accessToken) throws Exception {
        return performAction(
                patch(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON).header("Authorization", "Bearer " + accessToken),
                Void.class);
    }
    ...
    protected <T> ApiResponse<T> patchAction(String uri, Object request, String accessToken, Class<T> responseType)
            throws Exception {
        return performAction(patch(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", "Bearer " + accessToken).content(objectMapper.writeValueAsString(request)),
                responseType);
    }
    ...
    protected <T> ApiResponse<T> patchAction(String uri, Object request, Class<T> responseType) throws Exception {
        return performAction(
                patch(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(request)),
                responseType);
    }
    ...
    protected ApiResponse<Void> patchAction(String uri) throws Exception {
        return performAction(patch(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON), Void.class);
    }
    ...
    protected ApiResponse<Void> deleteAction(String uri, String accessToken) throws Exception {
        return performAction(
                delete(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON).header("Authorization", "Bearer " + accessToken),
                Void.class);
    }
    ...
    protected ApiResponse<Void> deleteAction(String uri) throws Exception {
        return performAction(delete(uri).with(csrf()).contentType(MediaType.APPLICATION_JSON), Void.class);
    }
