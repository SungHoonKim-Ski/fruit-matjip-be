...
- 19시 5분 기준 찾아가지 않은 예약은 자동으로 취소되며 재고가 복원됩니다.
...
- [ ] **관리자 판매량 조회 집계 기능 적용**: 판매량 조회 시 예약 테이블 full scan으로 인한 성능 저하 우려
- [ ] **날짜별 품목 노출 순서 기능**: 제품량 증가로 인해 사용자에게 보일 품목의 순서 지정 필요성
